  ...
  const load = useCallback(async () => {
    ...
    try {
      const [kpiRes, stockRes, lowRes, reorderRes, locRes] = await Promise.allSettled([
        axios.get(`${API}/api/warehouse/dashboard-kpi`, { headers: hdrs }),
        axios.get(`${API}/api/warehouse/stock`, { headers: hdrs }),
        ...
        axios.get(`${API}/api/warehouse/locations`, { headers: hdrs }),
      ]);
